...
export const ActionButton = (prop: ActionButtonArg) => {
    ...
    return (
        // <button className={`bg-cyan-900 w-full rounded-[68px] pb-2 pr-2 hover:pb-0 hover:pr-0 ${outerButtonClassName}`}>
