...
import type { VoidFunc } from "@/interfaces";
...
export const PermissionPopUp : React.FC<{children: React.ReactNode;}> = ({children }) => {
    ...
    return (
        <TransactionWindow openDrawer={popUpDrawer === 'permission'} styles={{background: '#121212', display: 'flex', flexDirection: 'column', justifyItems: 'center', gap: '16px'}}>
            <Stack className={`p-4 lg:p-8 flex justify-between gap-6 md:text-xl text-orange-200`}>
