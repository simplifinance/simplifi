...
export const TableChild = ({ open, formattedPool, actions, handleModalClose } : TableChildProps) => {
    ...
    return(
        ...
        <PopUp modalOpen={open} handleModalClose={handleModalClose}>
            <Container maxWidth="md" className="h-screen md:max-h-[550px] space-y-4 overflow-y-hidden md:overflow-y-auto">
                <Box className="p-4 lg:p-8 rounded-lg space-y-12 text-lg bg-green1 text-white1 border shadow-lg shadow-yellow-100">
