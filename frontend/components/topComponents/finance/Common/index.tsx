  ...
  return(
    <div className='space-y-4'>
      <div className="flex justify-between items-center">
        <h3 className='hidden md:block w-[50%] text-[50px] font-black text-orange-300 text-left '>{heroTitle2}</h3>
        <ul className={`text-[12px] md:text-[16px] font-semibold text-orange-200 ${flexSpread} gap-2 md:gap-6`}>
          <li className={`flex flex-col justify-center items-center text-center`}>
            <h3 className={"bg-green1 p-2 w-10 text-center rounded-full"}>{pools.length}</h3>
            <h3>Onchain Pools</h3>
          </li>
          <li className={`flex flex-col justify-center items-center text-center`}>
            <h1 className="bg-green1 p-2 w-10 text-center rounded-full">
