...
export const Common : React.FC<{heroTitle2: string, operation: Operation}> = ({heroTitle2, operation}) => {
  ...
  return(
    <Box className='space-y-6 min-w-[550px] overflow-auto pr-4 md:pr-0'>
      <Box className="w-full space-y-4 md:space-y-0 md:flex justify-between">
        <div className=''>
          <h3 className='w-full text-xl font-black text-white1 text-left'>Liquidity Pools</h3>
        </div>
        <div className={`w-full text-xl font-bold ${flexSpread} gap-6 text-white1`}>
