...
const Dashboard : React.FC = () => {
  ...
  return (
    <React.Fragment>
      <ul className={`w-full text-[8px] md:text-[10px] text-orange-200 ${flexEven} shadow shadow-green1 p-4 rounded-[26px] mb-4 md:gap-2`}>
        <li className={`flex flex-col justify-center items-center text-center`}>
          <h3 className={"text-center text-[16px] md:text-[26px] rounded-full"}>{pools.length}</h3>
          <h3>Onchain Pools</h3>
        </li>
        <li className={`flex flex-col justify-center items-center text-center`}>
          ...
          {/* <h1 className="bg-green1 p-2 size-[24px] md:size-[80px] text-center rounded-full">
          </h1> */}
