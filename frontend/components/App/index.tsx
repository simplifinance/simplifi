...
const setIcon = (linkActive: boolean) => {
  return {
    'dashboard': <span className={`${linkActive? "" : ""}`} >
      <svg width="20" height="20" viewBox="0 0 20 20" fill="#D1F3DC" xmlns="http://www.w3.org/2000/svg">
    ...
    'liquidity': <span className={`${linkActive? "" : ""}`} >
    ...
    'invest': <span className={`${linkActive? "" : ""}`} >
    ...
    'digdao': <span className={`${linkActive? "" : ""}`} >
    ...
    'speeddoc': <span className={`${linkActive? "" : ""}`} >
