...
const celoOracleData : PriceData[] = [
    {
        latestPrice: 0n,
...
const alfajoresOracleData : PriceData[] = [
    {
        latestPrice: 0n,
        timestampOflatestPrice: 0n,
        oracleAddress: '0x022F9dCC73C5Fb43F2b4eF2EF9ad3eDD1D853946', // The oracle address is not correct since the token is yet to launch
...
const crossFiOracleData : PriceData[] = [
    {
        latestPrice: 0n,
        timestampOflatestPrice: 0n,
...
export const getSupportedAssets = (networkName: NetworkName, additionalSupportedAssets: string[]) => {
    let assets : SupportedAsset[] = [];
    let priceData : PriceData[] = [];

    switch (networkName) {
        case 'crosstestnet':
            assert(additionalSupportedAssets.length == crossFiOracleData.length);
        ...
        case 'alfajores':
            assert(additionalSupportedAssets.length == alfajoresOracleData.length);
            priceData = alfajoresOracleData;
        
        case 'celo':
            assert(additionalSupportedAssets.length == celoOracleData.length);
            priceData = celoOracleData;
