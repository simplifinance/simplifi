...
//     _clearDebt(self, pb.epochId, pb.user);
...
//     ced = Common.CommonEventData(_fetchPool(self, pb.epochId), ced.pool.cData[drv.slot].cData.loan, ced.pool.cData[drv.slot].cData.colBals);
//     _setClaim(
...
//     self.poolArr[epochId].cData[slot].cData.loan = 0;
//   }
