...
} from "../../../contracts/peripherals/Contributor";
...
export class Contributor__factory {
  static readonly abi = _abi;
  static createInterface(): ContributorInterface {
    return new Interface(_abi) as ContributorInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): Contributor {
    return new Contract(address, _abi, runner) as unknown as Contributor;
  }
}
