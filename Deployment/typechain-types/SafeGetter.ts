...
export interface SafeGetterInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "pause"
      | "paused"
...
export interface SafeGetter extends BaseContract {
  connect(runner?: ContractRunner | null): SafeGetter;
  waitForDeployment(): Promise<this>;

  interface: SafeGetterInterface;
