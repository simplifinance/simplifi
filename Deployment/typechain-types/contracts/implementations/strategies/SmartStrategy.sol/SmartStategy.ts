...
export interface SmartStategyInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "activateStrategy"
      | "closeTo"
...
export interface SmartStategy extends BaseContract {
  connect(runner?: ContractRunner | null): SmartStategy;
  waitForDeployment(): Promise<this>;

  interface: SmartStategyInterface;
