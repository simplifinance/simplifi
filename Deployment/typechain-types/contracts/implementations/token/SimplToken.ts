...
export interface SimplTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "accountBalances"
      | "allowance"
...
export interface SimplToken extends BaseContract {
  connect(runner?: ContractRunner | null): SimplToken;
  waitForDeployment(): Promise<this>;

  interface: SimplTokenInterface;
