...
export interface TestUSDInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface TestUSD extends BaseContract {
  connect(runner?: ContractRunner | null): TestUSD;
  waitForDeployment(): Promise<this>;

  interface: TestUSDInterface;
