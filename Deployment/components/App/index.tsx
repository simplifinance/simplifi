...
export default function App(props: AppProps) {
  ...
  return (
    <Box className="">
      ...
      <Stack className={`py- px-4 ${location === '/dashboard'? 'space-y-24' : 'space-y-14'} '`}>
        <nav style={{ width: `calc(100% - ${DRAWERWIDTH}px)`,  marginLeft: `${DRAWERWIDTH}px`, borderBottom: '1px solid rgba(255, 255, 255, 0.2)', }} className={`fixed p-4  ${flexSpread} bg-green1`}>
          <div className='w-[20%]'>
