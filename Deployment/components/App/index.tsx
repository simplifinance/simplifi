...
export default function App() {
  ...
  return (
    <div className='appContainer bg-[url(/images/hero/hero-bg1.png)] object-cover'>
      ...
      <main className='md:pl-4 py-[12px] md:py-[36px] md:pr-[22px] space-y-4'>
        <MotionDivWrap className={`minHeight md:border-4 border-white1/20 rounded-[26px md:rounded-[56px] px-4 py-10 bg-gray1 relative`} >
          <Outlet />
        </MotionDivWrap>
        <Footer />
      </main>
