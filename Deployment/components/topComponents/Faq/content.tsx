export const faqContent = [
    {
        ...
        content: <p>FlexPool is a fancy name given to a custom liquidity pool that is operated by an individual. They&apos;re created primarily for the benefits raising capital for specific purpose (s). It may be permissioned <span className="text-orange-400 font-bold">(for closed group or peers who are familiar with one another)</span> or permissionless <span className="text-orange-400 font-bold">(open for anyone to participate)</span>. A worthy exception 
    ...
    },
    {
        ...
        subparagraph: <p>
            <span className="text-orange-300">NOTE:</span> Liquidation may cause participants in a permissioned pool to forfeit 
