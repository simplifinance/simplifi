...
export const DrawerWrapper = ({rest, openDrawer, children} : {rest?: React.CSSProperties, openDrawer: boolean, children: React.ReactNode}) => {
    return(
        <TransactionWindow openDrawer={openDrawer} styles={{ display: 'flex', flexDirection: 'column', justifyItems: 'center', gap: '16px', color: '#fed7aa', ...rest}}>
            { children }
        </TransactionWindow>
    );
}
...
export const Providers: React.FC<ProvidersProps> = ({cData_formatted}) => {
    ...
    return(
        <DrawerWrapper openDrawer={popUpDrawer === 'providers'} rest={{height: "100%"}}>
