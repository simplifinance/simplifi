...
import CollapsibleComponent from '@/components/utilities/Collapsible';
...
export default function OnchainStatistics() {
  ...
  const showStats = () => {
    return(
      <div className='space-y-4 relative font-bold'>
        <div className='grid grid-cols-1 md:grid-cols-2 gap-2'>
          {/* Epoches */}
          <div className={`relative bg-whit dark:bg-green1/50 space-y-4 w-full `}>
      ...
      <div className='flex flex-col gap-1 w-full mx-auto'>
        <AnimatePresence>
          <div className='w-full mx-auto p-4'>
            <CollapsibleComponent triggerText='Onchain Statistics'>
              { showStats() }
