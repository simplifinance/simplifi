...
import SignUpForRewards from "@/components/AppFeatures/FlexPool/update/transactions/SignUpForRewards";
...
export default function SignUp() {
    ...
    return(
         <div className="bg-white dark:bg-green1/80 text-green1/80 dark:text-orange-200 p-4 rounded-lg space-y-2 text-sm">
            <h3 className="text-lg font-semibold dark:text-orange-300">Earn points</h3>
