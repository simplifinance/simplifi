  ...
  return(
    <aside className={`${!showSidebar? 'hidden' : 'flex w-fit'} md:flex z-50 md:p-[16px]`}>
      <div className="w-full relative md:rounded-xl min-h-[fit-content] bg-white1 dark:bg-green1 md:dark:bg-gray1 md:border border-green1/30 dark:border-gray1 animateSidebar">
        ...
        { activePath === 'Flexpool'? <OnchainStatistics /> : <LeftSideBarContent /> }
      </div>
    </aside>
  );
}
...
const leftSideBarContent : {
...
}[] = Array.from([
  {
    ...
    icon: 
      ...
      <path d="M2.86719 21.4849H22.1359V14.6631L2.86719 21.4849ZM3.8724 19.6292L11.6797 11.8229L14.3401 14.4834L22.1359 6.68753V12.4459L3.8724 19.6292ZM16.3333 6.68701H22.1359H16.3333Z" fill="#000"/>
