...
export default function Navbar() {
    ...
    return(
      <nav className={`${flexSpread} dark:bg-green1 md:border-b  border-b-green1/30 dark:border-none p-4 z-50 bg-white1`}>
        ...
        <div className={`flex justify-between md:w-full md:justify-end w-full md:px-4 lg:gap-4`}>
          ...
          <div className='hidden md:block bg-green1 dark:bg-white1 px-3 py-2 rounded-[16px] text-white1/80 dark:text-green1 font-extrabold'>
            <Typed 
